...
<!-- 			            pull-right   -->   	<button type="submit" class="btn btn-info pull-right" >submit</button>
		          	...
		          	<div class="col-md-6">
			          	...
			          	<div class="box-body">
                     			<h5 style="line-height:180%;"><b>DiseaseEnhancer</b> supports batch search, which allows user to select <em>disease names</em> or input <em>genomic regions</em> or <em>upload a "BED3" format file</em> for searching the disease-enhancers overlaped with the regions you input. The BED file should be in tab delimited format without header. Each line of the file must be a BED3 format record. Information about <a href="http://genome.ucsc.edu/FAQ/FAQformat.html#format1">UCSC BED format</a>.</h5>
								<h4>Input file format</h4>
								<table class="table table-hover">
									<tr><td>chr1</td><td>10838</td><td>25373</td></tr>
									<tr><td>chr1</td><td>2323515</td><td>2343843</td></tr>
									<tr><td>chr1</td><td>6519162</td><td>6532309</td></tr>
									<tr><td>chr1</td><td>16922311</td><td>16966402</td></tr>
									<tr><td>chr1</td><td>17014921</td><td>17015568</td></tr>
