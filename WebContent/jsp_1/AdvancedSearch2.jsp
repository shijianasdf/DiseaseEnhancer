...
<!-- 			           <div class="col-md-8"> -->
			           <form class="form-inline" role="form" action="Search" method="post" enctype ="multipart/form-data">
			                ...
			                <label for="inputPassword1">Enhancer Target Gene:</label>
			                    <select id="inputPassword1" name="gene" class="form-control" multiple="multiple" placeholder="To select multiple samples, hold ctrl button while click." data-toggle="tooltip" data-placement="top" >
			                ...
			                <div class="form-group" style="margin-left:20px">
			                 ...
			                 <script>
			                 	$('#inputPassword4').on('keydown',function(){
			                 		$('#exampleInputFile').attr("disabled","disabled");
			                 	}).on('keyup',function(){
			                 		if($('#inputPassword4').val()==""){
			                 			$('#exampleInputFile').attr("disabled",false);
			                 		}
			                 	});
			                 	$('#exampleInputFile').on('mouseover',function(){
			                 		$('#inputPassword4').attr("disabled","disabled");
			                 	 ...
			                 	 function multiselect_deselect($id){
			                 		//@param select_id 
			                 	    $('#'+$id+' option').each(function(){
			                 	    	if($(this).val()!=null){
			                 	    	 	$("#"+$id).multiselect('deselect', $(this).val());
			                 	        }	
			                 	    });
			                 	 }
			                 </script>
			              ...
			              <!-- /.box-body -->
			              	<div class="box-footer" >
			                	<button  type="button" class="btn btn-danger" onclick="$('#inputPassword1').multiselect('select','MYC');$('#inputPassword4').val('chr8:126998202-128990000');">Demo</button>
			                	<button  type="button" class="btn btn-success" onclick="multiselect_deselect('inputPassword1');multiselect_deselect('select1');$('#inputPassword4').val('');$('#exampleInputFile').val('');$('#inputPassword4').attr('disabled',false);$('#exampleInputFile').attr('disabled',false);">Reset</button>
<!-- 			            pull-right   -->   	<button type="submit" class="btn btn-info" style="margin-left:390px;">submit</button>
			              	</div>
			              	</div>
			              <!-- /.box-footer -->
			            </form>
