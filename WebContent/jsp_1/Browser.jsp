			      		...
			      		success:function(returnMsg){
			      			if(returnMsg.status == "success"){
			      				...
			      				for(var i=0;i<resulttable.length;i++){
			      					$("#detailInformation tbody").append("<tr><td>"+resulttable[i].id+"</td><td>"+resulttable[i].vartype+"</td><td>"+resulttable[i].varname+"</td><td>"+resulttable[i].varchr+":"+resulttable[i].varstart+"-"+resulttable[i].varend+"</td><td>"+resulttable[i].targetgene+"</td><td>"+resulttable[i].muttype+"</td><td>"+resulttable[i].varcons+"</td><td>"+resulttable[i].pmid+"</td></tr>");
			      				}
			      				$("#Detailed").show();
