		            ...
		            <div class="box-body">
		               <table class="table table-bordered table-hover col-lg-9">
							...
							<tbody><tr>
								...
								<td>
									<strong>This file contains 847 disease enhancers in 143 human disease, involving 308 target genes. Sorted by disease name.The information of each entry arranged as following:</strong></br>
									...
									<strong>- TargetGene</strong>: disease enhancer-associated gene, veritified by 3C-like experiments, or gene pertubation experiments, or &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bioinfomatics methods.
								</td>
								<td><a href="/DiseaseEnhancer/RFunctions/enh2disease.txt" class="btn btn-primary"><i class="fa fa-download"></i> Download</a></td>
							</tr><tr>
								<td>The mutation information annotated for disease-enhancer:</td>
								<td><strong>This file contains the curated annotation of the variants on the disease enhancers, involving 1450 enhancer-associated variants. Sorted by target gene  name.The information of each entry arranged as following:</strong></br>
									<strong>- id</strong>: unique identifier for each enhancer in DiseaseEnhancer database</br>
									...
									<strong>- TargetGene</strong>: disease enhancer-associated gene, veritified by 3C-like experiments, or gene pertubation experiments, or &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bioinfomatics methods.</br>
								...
								<td><a href="/DiseaseEnhancer/RFunctions/enhInfo.txt" class="btn btn-primary"><i class="fa fa-download"></i> Download</a></td>
							</tr>
							<tr>
								<td>The information annotated for enhancer-target:</td>
								<td><strong>This file contains 603 unique enhancer-gene interactions. Sorted by disease name.The information of each entry arranged as following:</strong></br>
									<strong>- id</strong>: unique identifier for each enhancer in DiseaseEnhancer database.</br>
									<strong>- chr, start, end</strong>: genomic location of disease enhancers.</br>
									<strong>- TargetGene</strong>: disease enhancer-associated gene, veritified by 3C-like experiments, gene pertubation experiments, or &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bioinfomatics methods.
								</td>
								<td><a href="/DiseaseEnhancer/RFunctions/enh2target.txt" class="btn btn-primary"><i class="fa fa-download"></i> Download</a></td>
							</tr>
							</tbody>
						</table>
		            </div>
