...
<html class="no-js">
  ...
  <body>
    ...
    d3.json('plugins/gd3-master/demo/testData/example-cna.json', function(data) {
      d3.select('#cna')
        .datum(data.PDGFRA)
        .call(gd3.cna());
    });

    d3.json('plugins/gd3-master/demo/testData/example-graph.json', function(data) {
      var style = {
    ...
    d3.json('plugins/gd3-master/demo/testData/example-heatmap.json', function(data) {
      d3.json('plugins/gd3-master/demo/testData/exampleAnnotations.json', function(adata) {
    ...
    d3.json('plugins/gd3-master/demo/testData/example2-mutation-matrix.json', function(data) {
      d3.json('plugins/gd3-master/demo/testData/exampleAnnotations.json', function(annData) {
        var mutMtxStyle = {
          width: 800
        }
    ...
    d3.json('plugins/gd3-master/demo/testData/example2-transcript.json', function(data) {
    ...
    d3.json('plugins/gd3-master/demo/testData/example-dendrogram-N30.json', function(data) {
